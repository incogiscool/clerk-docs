...
The waitlist hosts the prebuilt [`<Waitlist />`](/docs/components/waitlist/overview) component, which renders a waitlist form that allows users to join for early access to your application.
