...
The waitlist page hosts the prebuilt [`<Waitlist />`](/docs/components/waitlist/overview) component, which renders a form that allows users to join for early access to your application.
