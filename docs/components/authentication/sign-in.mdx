...
<Properties>
  ...
  This URL will be used to redirect your users to waitlist page. If this option is `undefined`, the waitlist URL will redirect to the Account Portal waitlist page.
</Properties>
