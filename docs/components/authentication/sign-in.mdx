...
<Properties>
  ...
  This URL will be used for any redirects that might happen and needs to point to your primary application on the client-side. If this option is `undefined`, the waitlist URL will redirect to the Account Portal waitlist page.
</Properties>
