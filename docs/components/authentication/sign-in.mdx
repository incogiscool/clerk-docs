...
<Properties>
  ...
  This URL will be used for any redirects that might happen and needs to point to your primary application on the client-side. This option is optional for production and development instances. If this option is undefined the waitlist url will redirect to waitlist page in the account portal.
</Properties>
